...
public class IguanaConfig {
    ...
    public static final ConfigCategory CATEGORY_GETTING_SEEDS =
            addCategory("getting seeds", "Options for obtaining seeds");
    public static final ConfigCategory CATEGORY_DELAYS =
            addCategory("delays", "Delays for various obtaining food related activities");
    public static final ConfigCategory CATEGORY_HARVESTING =
            addCategory("harvesting", "Options related to drops from crops");
    public static final ConfigCategory CATEGORY_CUSTOM_FIELD =
            addCategory("custom field", "Options for enabling and manipulating a custom field in Villages");
    public static final ConfigCategory CATEGORY_DIFFICULTY_SCALING = addCategory(
            "difficulty scaling", "Options to scale the difficulty of certain elements based on game difficulty");
    public static final ConfigCategory CATEGORY_FOOD = addCategory("food", "Food related options");
    public static final ConfigCategory CATEGORY_HARVESTCRAFT = addCategory(
            "harvestcraft",
            "Options related to HarvestCraft.\n" + EnumChatFormatting.RED + "Only works if HarvestCraft is installed!");
    public static final ConfigCategory CATEGORY_NATURA = addCategory(
            "natura", "Options related to Natura.\n" + EnumChatFormatting.RED + "Only works if Natura is installed!");
    ...
    public static final ConfigCategory CATEGORY_LOW_STATS =
            addCategory("low stats", "Options for how to handle when the player get low health/hunger");
    ...
    public static <T> ConfigOption<T> addOption(
            ConfigCategory category, String name, T defaultValue, T blankSlate, String comment) {
    ...
    public static <T> ConfigOption<T> putOptionInList(
            ConfigCategory category,
            String name,
            T defaultValue,
            T minValue,
            ...
            T blankSlate,
            String comment,
            List<ConfigOption<?>> list) {
        ConfigOption<T> configOption =
                new ConfigOption<T>(category.name, name, defaultValue, minValue, maxValue, blankSlate, comment);
        list.add(configOption);
        return configOption;
    }

    // seeds + hoes
    public static final ConfigOption<Boolean> allSeedsEqualOption = addOption(
            CATEGORY_GETTING_SEEDS,
            "allSeedsEqual",
            true,
            false,
            "Each seed has an equal chance to drop (grass drops and via hoes)");
    public static boolean allSeedsEqual;
    public static final ConfigOption<Boolean> removeTallGrassSeedsOption = addOption(
            CATEGORY_GETTING_SEEDS, "removeTallGrassSeeds", true, false, "Removes seed drops when breaking tall grass");
    public static boolean removeTallGrassSeeds;
    public static final ConfigOption<Boolean> modifyHoeUseOption = addOption(
            CATEGORY_GETTING_SEEDS,
            "modifyHoeUse",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> removeHoeRecipesOption = addOption(
            CATEGORY_GETTING_SEEDS, "removeHoeRecipes", true, false, "Whether wood and stone hoe recipes are removed");
    public static boolean removeHoeRecipes;
    public static final ConfigOption<Integer> hoeToolDamageMultiplierOption = addOption(
            CATEGORY_GETTING_SEEDS,
            "hoeToolDamageMultiplier",
            5,
            1,
            null,
            1,
    ...
    public static final ConfigOption<Integer> seedChanceOption = addOption(
            CATEGORY_GETTING_SEEDS,
            "seedChance",
            20,
            0,
            100,
            20,
            "Percent chance for seed to drop from hoe use on normal difficulty ('modifyHoeUse' must be true)");
    public static int seedChance;
    public static final ConfigOption<Boolean> addSeedsCraftingRecipeOption = addOption(
            CATEGORY_GETTING_SEEDS,
    ...
    // delays
    public static final ConfigOption<Float> noSunlightRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "noSunlightRegrowthMultiplier",
            2f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> wrongBiomeRegrowthMultiplierSugarcaneOption = addOption(
            CATEGORY_DELAYS,
            "wrongBiomeRegrowthMultiplierSugarcane",
            2f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> flowerRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "flowerRegrowthMultiplier",
            1f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> cropRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "cropRegrowthMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> cactusRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "cactusRegrowthMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> cocoaRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "cocoaRegrowthMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> sugarcaneRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "sugarcaneRegrowthMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> treeCropRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "treeCropRegrowthMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> saplingRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "saplingRegrowthMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> netherWartRegrowthMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "netherWartRegrowthMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> dryingRackTimeMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "dryingRackTimeMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> eggTimeoutMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "eggTimeoutMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> breedingTimeoutMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "breedingTimeoutMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Float> childDurationMultiplierOption = addOption(
            CATEGORY_DELAYS,
            "childDurationMultiplier",
            4f,
            0f,
            null,
            1f,
    ...
    public static final ConfigOption<Integer> milkedTimeoutOption = addOption(
            CATEGORY_DELAYS,
            "milkedTimeout",
            20,
            0,
    ...
    // crop drops
    public static final ConfigOption<Boolean> enableRightClickHarvestingOption = addOption(
            CATEGORY_HARVESTING,
            "enableRightClickHarvesting",
            true,
            false,
            "Enables/disables harvest crops by right clicking them");
    public static boolean enableRightClickHarvesting;
    public static final ConfigOption<Boolean> modifyCropDropsRightClickOption = addOption(
            CATEGORY_HARVESTING,
            "modifyCropDropsRightClick",
            true,
            false,
            "Enables/disables modification of the item drops of crops when right clicking them (produce and seeds)");
    public static boolean modifyCropDropsRightClick;
    public static final ConfigOption<Boolean> modifyCropDropsBreakOption = addOption(
            CATEGORY_HARVESTING,
            "modifyCropDropsBreak",
            true,
            false,
            "Enables/disables modification of the item drops of crops when breaking them (produce and seeds)");
    public static boolean modifyCropDropsBreak;
    public static final ConfigOption<Integer> seedsPerHarvestRightClickMinOption = addOption(
            CATEGORY_HARVESTING,
            "seedsPerHarvestRightClickMin",
            0,
            0,
            null,
            0,
            "Minimum number of seeds you get when harvesting a non-tree crop with right click (modifyCropDrops must be true)");
    public static int seedsPerHarvestRightClickMin;
    public static final ConfigOption<Integer> seedsPerHarvestRightClickMaxOption = addOption(
            CATEGORY_HARVESTING,
            "seedsPerHarvestRightClickMax",
            0,
            0,
            null,
            0,
            "Maximum number of seeds you get when harvesting a non-tree crop with right click (modifyCropDrops must be true)");
    public static int seedsPerHarvestRightClickMax;
    public static final ConfigOption<Integer> seedsPerHarvestBreakMinOption = addOption(
            CATEGORY_HARVESTING,
            "seedsPerHarvestBreakMin",
            0,
            0,
            null,
            0,
            "Minimum number of seeds you get when harvesting a non-tree crop by breaking it (modifyCropDrops must be true)");
    public static int seedsPerHarvestBreakMin;
    public static final ConfigOption<Integer> seedsPerHarvestBreakMaxOption = addOption(
            CATEGORY_HARVESTING,
            "seedsPerHarvestBreakMax",
            0,
            0,
            null,
            0,
            "Maximum number of seeds you get when harvesting a non-tree crop by breaking it (modifyCropDrops must be tree)");
    public static int seedsPerHarvestBreakMax;
    public static final ConfigOption<Integer> producePerHarvestRightClickMinOption = addOption(
            CATEGORY_HARVESTING,
            "producePerHarvestRightClickMin",
            2,
            0,
            null,
            2,
            "Minimum number of produce you get when harvesting a non-tree crop with right click (modifyCropDrops must be true)");
    public static int producePerHarvestRightClickMin;
    public static final ConfigOption<Integer> producePerHarvestRightClickMaxOption = addOption(
            CATEGORY_HARVESTING,
            "producePerHarvestRightClickMax",
            4,
            0,
            null,
            4,
            "Maximum number of produce you get when harvesting a non-tree crop with right click (modifyCropDrops must be true)");
    public static int producePerHarvestRightClickMax;
    public static final ConfigOption<Integer> producePerHarvestBreakMinOption = addOption(
            CATEGORY_HARVESTING,
            "producePerHarvestBreakMin",
            2,
            0,
            null,
            2,
            "Minimum number of produce you get when harvesting a non-tree crop by breaking it (modifyCropDrops must be true)");
    public static int producePerHarvestBreakMin;
    public static final ConfigOption<Integer> producePerHarvestBreakMaxOption = addOption(
            CATEGORY_HARVESTING,
            "producePerHarvestBreakMax",
            4,
            0,
            null,
            4,
            "Maximum number of produce you get when harvesting a non-tree crop by breaking it (modifyCropDrops must be true)");
    public static int producePerHarvestBreakMax;
    public static final ConfigOption<Float> bonemealEffectivenessOption = addOption(
            CATEGORY_HARVESTING,
            "bonemealEffectiveness",
            0.5f,
            0.0f,
            1.0f,
            1.0f,
            "Multiplier on the effectiveness of bonemeal; the smaller this is, the more often bonemeal will fail to create growth. Set to 0 to disable bonemeal completely.");
    public static float bonemealEffectiveness;
    public static final ConfigOption<Boolean> modifyBonemealGrowthOption = addOption(
            CATEGORY_HARVESTING,
            "modifyBonemealGrowth",
            true,
            false,
            "Reduces the amount of growth from a successful bonemeal on certain plants (uses IguanaMan's opinionated values)");
    public static boolean modifyBonemealGrowth;

    // village field
    public static final ConfigOption<Boolean> addCustomVillageFieldOption =
            addOption(CATEGORY_CUSTOM_FIELD, "addCustomVillageField", true, false, "Adds a custom field to villages");
    public static boolean addCustomVillageField;
    public static final ConfigOption<Integer> fieldNormalWeightOption = addOption(
    ...
    public static final ConfigOption<Integer> fieldReedWeightOption = addOption(
            CATEGORY_CUSTOM_FIELD,
            "fieldReedWeight",
            10,
            0,
    ...
    public static final ConfigOption<Integer> fieldStemWeightOption = addOption(
            CATEGORY_CUSTOM_FIELD,
            "fieldStemWeight",
            10,
            0,
    ...
    // difficulty scaling
    public static final ConfigOption<Boolean> difficultyScalingOption = addOption(
            CATEGORY_DIFFICULTY_SCALING,
            "difficultyScaling",
            true,
            false,
            "Enable/Disable all difficulty scaling effect in one setting");
    public static boolean difficultyScaling;
    public static final ConfigOption<Boolean> difficultyScalingBoneMealOption = addOption(
            CATEGORY_DIFFICULTY_SCALING,
            "difficultyScalingBoneMeal",
            true,
            false,
            "Effects of bone meal dependant of difficulty ('difficultyScaling' and 'modifyBonemealGrowth' must be true)");
    public static boolean difficultyScalingBoneMeal;
    public static final ConfigOption<Boolean> difficultyScalingEffectsOption = addOption(
            CATEGORY_DIFFICULTY_SCALING,
            "difficultyScalingEffects",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> difficultyScalingHealingOption = addOption(
            CATEGORY_DIFFICULTY_SCALING,
            "difficultyScalingHealing",
            true,
            false,
            "Healing rate scales by difficulty ('difficultyScaling' must be true)");
    public static boolean difficultyScalingHealing;
    public static final ConfigOption<Boolean> difficultyScalingHungerOption = addOption(
            CATEGORY_DIFFICULTY_SCALING,
            "difficultyScalingHunger",
            true,
            false,
            "Hunger loss rate is reduced relative to difficulty ('difficultyScaling' must be true)");
    public static boolean difficultyScalingHunger;
    public static final ConfigOption<Boolean> harderScalingHungerOption = addOption(
            CATEGORY_DIFFICULTY_SCALING,
            "harderScalingHunger",
            true,
            false,
            "Hunger loss rate is increased in Hard ('difficultyScalingHunger' and 'difficultyScaling' must be true)");
    public static boolean harderScalingHunger;

    public static final ConfigOption<Boolean> difficultyScalingRespawnHungerOption = addOption(
            CATEGORY_DIFFICULTY_SCALING,
            "difficultyScalingRespawnHunger",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> modifyFoodValuesOption =
            addOption(CATEGORY_FOOD, "modifyFoodValues", true, false, "Enables/disables all food value modification");
    public static boolean modifyFoodValues;
    public static final ConfigOption<Boolean> useHOFoodValuesOption = addOption(
            CATEGORY_FOOD,
            "useHOFoodValues",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> addFoodTooltipsOption = addOption(
            CATEGORY_FOOD, "addFoodTooltips", true, false, "Add tooltips to food items showing hints at food value");
    public static boolean addFoodTooltips;
    public static final ConfigOption<Boolean> modifyFoodStackSizeOption = addOption(
            CATEGORY_FOOD,
            "modifyFoodStackSize",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> modifyFoodEatingSpeedOption = addOption(
            CATEGORY_FOOD,
            "modifyFoodEatingSpeed",
            true,
            false,
    ...
    public static final ConfigOption<Integer> foodStackSizeMultiplierOption = addOption(
            CATEGORY_FOOD,
            "foodStackSizeMultiplier",
            1,
            1,
            null,
            1,
    ...
    public static final ConfigOption<Float> modFoodValueDividerOption =
            removeOption(CATEGORY_FOOD, "modFoodValueDivider", 4.0f);

    @Deprecated
    public static int modFoodValueDivider;

    public static final ConfigOption<Float> foodHungerDividerOption = addOption(
            CATEGORY_FOOD,
            "foodHungerDivider",
            4.0f,
            1.0f,
    ...
    public static final ConfigOption<Float> foodSaturationDividerOption = addOption(
            CATEGORY_FOOD,
            "foodSaturationDivider",
            1.0f,
            1.0f,
    ...
    public static final ConfigOption<Float> foodHungerToSaturationDividerOption = addOption(
            CATEGORY_FOOD,
            "foodHungerToSaturationDivider",
            20.0f,
            0.0f,
    ...
    public static final ConfigOption<Boolean> addWellFedEffectOption = addOption(
            CATEGORY_FOOD, "addWellFedEffect", true, false, "Adds a 'well fed' effect that gives slight health regen");
    public static boolean addWellFedEffect;

    // harvestcraft integration
    public static final ConfigOption<Boolean> addTradesButcherOption = addOption(
            CATEGORY_HARVESTCRAFT,
            "addTradesButcher",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> addCropTradesFarmerOption = addOption(
            CATEGORY_HARVESTCRAFT,
            "addCropTradesFarmer",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> addSaplingTradesFarmerOption = addOption(
            CATEGORY_HARVESTCRAFT,
            "addSaplingTradesFarmer",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> addHarvestCraftChestLootOption = addOption(
            CATEGORY_HARVESTCRAFT,
            "addHarvestCraftChestLoot",
            true,
            false,
            "HarvestCraft items added to dungeon/temple chests (Harvestcraft)");
    public static boolean addHarvestCraftChestLoot;
    public static final ConfigOption<Integer> chestLootMaxStackSizeOption = addOption(
            CATEGORY_HARVESTCRAFT,
            "chestLootMaxStackSize",
            16,
            1,
            null,
            64,
    ...
    public static final ConfigOption<Integer> chestLootChanceOption = addOption(
            CATEGORY_HARVESTCRAFT,
            "chestLootChance",
            5,
            1,
    ...
    public static final ConfigOption<Boolean> foodsUnplantableOption = addOption(
            CATEGORY_HARVESTCRAFT,
            "foodsUnplantable",
            true,
            false,
    ...
    // natura integration
    public static final ConfigOption<Boolean> removeNaturaFlourCraftingRecipesOption = addOption(
            CATEGORY_NATURA,
            "removeNaturaFlourCraftingRecipes",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> removeNaturaFlourSmeltingRecipeOption = addOption(
            CATEGORY_NATURA,
            "removeNaturaFlourSmeltingRecipe",
            true,
            false,
            "Removes the default barley/wheat flour -> bread smelting recipes.");
    public static boolean removeNaturaFlourSmeltingRecipe;
    public static final ConfigOption<Boolean> addAlternateNaturaFlourCraftingRecipesOption = addOption(
            CATEGORY_NATURA,
            "addAlternateNaturaFlourCraftingRecipes",
            false,
            false,
            "Adds alternate recipes to turn barley/wheat into flour: 2x wheat/barley -> flour.");
    ...
    public static final ConfigOption<Boolean> constantHungerLossOption =
            addOption(CATEGORY_HUNGER, "constantHungerLoss", true, false, "You lose hunger (very slowly) at all times");
    public static boolean constantHungerLoss;
    public static final ConfigOption<Integer> damageOnStarveOption =
            addOption(CATEGORY_HUNGER, "damageOnStarve", 200, 2, "Amount of damage you take when hunger hits zero");
    public static int damageOnStarve;
    public static final ConfigOption<Integer> respawnHungerValueOption = addOption(
            CATEGORY_HUNGER,
            "respawnHungerValue",
            20,
            0,
            null,
            20,
            "hunger value set after respawning for peaceful/easy difficulty");
    public static int respawnHungerValue;
    public static final ConfigOption<Integer> respawnHungerDifficultyModifierOption = addOption(
            CATEGORY_HUNGER,
            "respawnHungerDifficultyModifier",
            4,
            0,
            null,
            4,
    ...
    public static final ConfigOption<Boolean> disableHealingHungerDrainOption = addOption(
            CATEGORY_HUNGER,
            "disableHealingHungerDrain",
            true,
            false,
    ...
    public static final ConfigOption<Float> hungerLossRatePercentageOption = addOption(
            CATEGORY_HUNGER,
    ...
    public static final ConfigOption<Boolean> addGuiTextOption =
            addOption(CATEGORY_LOW_STATS, "addGuiText", true, false, "Shows onscreen text when hunger/health is low");
    public static boolean addGuiText;
    public static final ConfigOption<Boolean> addLowStatEffectsOption = addOption(
            CATEGORY_LOW_STATS, "addLowStatEffects", true, false, "Enables/disables all low hunger/health effects");
    public static boolean addLowStatEffects;
    public static final ConfigOption<Boolean> addLowHealthNauseaOption = addOption(
            CATEGORY_LOW_STATS,
            "addLowHealthNausea",
            true,
            false,
            "Nausea effect when health is really low ('addLowStatEffects' must be true)");
    public static boolean addLowHealthNausea;
    public static final ConfigOption<Boolean> addLowHungerNauseaOption = addOption(
            CATEGORY_LOW_STATS,
            "addLowHungerNausea",
            true,
            false,
    ...
    public static final ConfigOption<Boolean> addLowHealthSlownessOption = addOption(
            CATEGORY_LOW_STATS,
            "addLowHealthSlowness",
            true,
            false,
            "Slowness effect when health is low ('addLowStatEffects' must be true)");
    public static boolean addLowHealthSlowness;
    public static final ConfigOption<Boolean> addLowHungerSlownessOption = addOption(
            CATEGORY_LOW_STATS,
            "addLowHungerSlowness",
            true,
            false,
            "Slowness effect when hunger is low ('addLowStatEffects' must be true)");
    public static boolean addLowHungerSlowness;
    public static final ConfigOption<Boolean> addLowHealthWeaknessOption = addOption(
            CATEGORY_LOW_STATS,
            "addLowHealthWeakness",
            true,
            false,
            "Weakness effect when health is low ('addLowStatEffects' must be true)");
    public static boolean addLowHealthWeakness;
    public static final ConfigOption<Boolean> addLowHungerWeaknessOption = addOption(
            CATEGORY_LOW_STATS,
            "addLowHungerWeakness",
            true,
            false,
            "Weakness effect when hunger is low ('addLowStatEffects' must be true)");
    public static boolean addLowHungerWeakness;
    public static final ConfigOption<Boolean> addLowHealthMiningSlowdownOption = addOption(
            CATEGORY_LOW_STATS,
            "addLowHealthMiningSlowdown",
            true,
            false,
            "Mining slowdown effect when health is low ('addLowStatEffects' must be true)");
    public static boolean addLowHealthMiningSlowdown;
    public static final ConfigOption<Boolean> addLowHungerMiningSlowdownOption = addOption(
            CATEGORY_LOW_STATS,
            "addLowHungerMiningSlowdown",
            true,
            false,
            "Mining slowdown effect when hunger is low ('addLowStatEffects' must be true)");
    public static boolean addLowHungerMiningSlowdown;

    // health
    public static final ConfigOption<Integer> minHungerToHealOption =
            addOption(CATEGORY_HEALTH, "minHungerToHeal", 7, 0, null, 18, "Minimum hunger level before healing starts");
    public static int minHungerToHeal;
    public static final ConfigOption<Boolean> foodRegensHealthOption =
            addOption(CATEGORY_HEALTH, "foodRegensHealth", false, false, "Eating food regenerates health");
    public static boolean foodRegensHealth;
    public static final ConfigOption<Integer> foodHealDividerOption = addOption(
            CATEGORY_HEALTH,
            "foodHealDivider",
            4,
            0,
    ...
    public static final ConfigOption<Integer> healthRegenRatePercentageOption = addOption(
            CATEGORY_HEALTH,
            "healthRegenRatePercentage",
            100,
            0,
            null,
            100,
    ...
    public static final ConfigOption<Boolean> modifyRegenRateOnLowHealthOption = addOption(
            CATEGORY_HEALTH,
            "modifyRegenRateOnLowHealth",
            true,
            false,
            "The lower your health the longer it takes to regen");
    public static boolean modifyRegenRateOnLowHealth;
    public static final ConfigOption<Integer> lowHealthRegenRateModifierOption = addOption(
            CATEGORY_HEALTH,
            "lowHealthRegenRateModifier",
            5,
            0,
            null,
            5,
            "The lower your health the longer it takes to regen, modify the effect here (lower = less effect) (modifyRegenRateOnLowHealth must be true)");
    ...
    public static final ConfigOption<Boolean> addSetHungerCommand =
            removeOption(CATEGORY_HUNGER, "addSetHungerCommand", true);

    @Deprecated
    public static final ConfigOption<Boolean> addSleepHungerLoss =
            removeOption(CATEGORY_HUNGER, "addSleepHungerLoss", false);

    @Deprecated
    public static final ConfigOption<Boolean> difficultyScalingSleepHungerLoss =
            removeOption(CATEGORY_DIFFICULTY_SCALING, "difficultyScalingSleepHungerLoss", true);

    @Deprecated
    public static final ConfigOption<Boolean> addLowStatNauseaOption =
            removeOption(CATEGORY_LOW_STATS, "addLowStatNausea", true);

    @Deprecated
    public static final ConfigOption<Boolean> addLowStatSlownessOption =
            removeOption(CATEGORY_LOW_STATS, "addLowStatSlowness", true);

    @Deprecated
    public static final ConfigOption<Boolean> addLowStatWeaknessOption =
            removeOption(CATEGORY_LOW_STATS, "addLowStatWeakness", true);

    @Deprecated
    public static final ConfigOption<Boolean> addLowStatMiningSlowdownOption =
            removeOption(CATEGORY_LOW_STATS, "addLowStatMiningSlowdown", true);

    @Deprecated
    public static final ConfigOption<Integer> seedsPerHarvestMinOption =
            removeOption(CATEGORY_HARVESTING, "seedsPerHarvestMin", 0);
    ...
    public static final ConfigOption<Integer> seedsPerHarvestMaxOption =
            removeOption(CATEGORY_HARVESTING, "seedsPerHarvestMax", 0);
    ...
    public static final ConfigOption<Integer> producePerHarvestMinOption =
            removeOption(CATEGORY_HARVESTING, "producePerHarvestMin", 2);
    ...
    public static final ConfigOption<Integer> producePerHarvestMaxOption =
            removeOption(CATEGORY_HARVESTING, "producePerHarvestMax", 4);

    @Deprecated
    public static int producePerHarvestMax;

    @Deprecated
    public static final ConfigOption<Boolean> modifyCropDropsOption =
            removeOption(CATEGORY_HARVESTING, "modifyCropDrops", true);
    ...
    public static void generateDefault() {
        defaultConfig.addCustomCategoryComment(
                " ",
                "This config contains all of the default Hunger Overhaul settings.\nIt's intended to serve as an easy backup for returning to the defaults.\nTo use, rename this file to HungerOverhaul.cfg (overwriting your current HungerOverhaul.cfg)");
        for (ConfigCategory configCategory : configCategories) {
    ...
    public static void reload(Configuration config) {
        ...
        if (config.hasCategory(" ")) config.removeCategory(config.getCategory(" "));
        ...
        modifyCropDropsRightClick =
                modifyCropDropsRightClickOption.getBackwardsCompatible(config, modifyCropDropsOption);
        modifyCropDrops = modifyCropDropsBreak;
        seedsPerHarvestRightClickMin =
                seedsPerHarvestRightClickMinOption.getBackwardsCompatible(config, seedsPerHarvestMinOption);
        seedsPerHarvestRightClickMax =
                seedsPerHarvestRightClickMaxOption.getBackwardsCompatible(config, seedsPerHarvestMaxOption);
        seedsPerHarvestBreakMin =
                seedsPerHarvestBreakMinOption.getBackwardsCompatible(config, seedsPerHarvestMinOption);
        seedsPerHarvestBreakMax =
                seedsPerHarvestBreakMaxOption.getBackwardsCompatible(config, seedsPerHarvestMaxOption);
        seedsPerHarvestMin = seedsPerHarvestRightClickMin;
        seedsPerHarvestMax = seedsPerHarvestRightClickMax;
        producePerHarvestRightClickMin =
                producePerHarvestRightClickMinOption.getBackwardsCompatible(config, producePerHarvestMinOption);
        producePerHarvestRightClickMax =
                producePerHarvestRightClickMaxOption.getBackwardsCompatible(config, producePerHarvestMaxOption);
        producePerHarvestBreakMin =
                producePerHarvestBreakMinOption.getBackwardsCompatible(config, producePerHarvestMinOption);
        producePerHarvestBreakMax =
                producePerHarvestBreakMaxOption.getBackwardsCompatible(config, producePerHarvestMaxOption);
        ...
        modifyBonemealGrowth =
                modifyBonemealGrowthOption.getBackwardsCompatible(config, difficultyScalingBoneMealOption);
        ...
        addLowHealthMiningSlowdown =
                addLowHealthMiningSlowdownOption.getBackwardsCompatible(config, addLowStatMiningSlowdownOption);
        addLowHungerMiningSlowdown =
                addLowHungerMiningSlowdownOption.getBackwardsCompatible(config, addLowStatMiningSlowdownOption);
