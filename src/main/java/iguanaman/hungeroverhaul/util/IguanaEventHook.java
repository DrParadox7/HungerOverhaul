...
public class IguanaEventHook {
                ...
                if (IguanaConfig.addLowStatEffects) {
                    ...
                    if (!creative && isPlayer && !event.entityLiving.isDead && healthPercent > 0f) {
                        ...
                        if (IguanaConfig.addLowHealthSlowness || IguanaConfig.addLowHungerSlowness)
                            if ((IguanaConfig.addLowHungerSlowness && foodLevel <= 1)
                                    || (IguanaConfig.addLowHealthSlowness && healthPercent <= 0.05F))
                                event.entityLiving.addPotionEffect(new PotionEffect(
                                        Potion.moveSlowdown.id, 19, 1 + difficultyModifierEffects, true));
                            else if ((IguanaConfig.addLowHungerSlowness && foodLevel <= 2)
                                    || (IguanaConfig.addLowHealthSlowness && healthPercent <= 0.10F))
                                event.entityLiving.addPotionEffect(
                                        new PotionEffect(Potion.moveSlowdown.id, 19, difficultyModifierEffects, true));
                            else if (((IguanaConfig.addLowHungerSlowness && foodLevel <= 3)
                                            || (IguanaConfig.addLowHealthSlowness && healthPercent <= 0.15F))
                                    && difficultyModifierEffects >= 1)
                                event.entityLiving.addPotionEffect(new PotionEffect(
                                        Potion.moveSlowdown.id, 19, -1 + difficultyModifierEffects, true));
                            else if (((IguanaConfig.addLowHungerSlowness && foodLevel <= 4)
                                            || (IguanaConfig.addLowHealthSlowness && healthPercent <= 0.20F))
                                    && difficultyModifierEffects >= 2)
                                event.entityLiving.addPotionEffect(new PotionEffect(
                                        Potion.moveSlowdown.id, 19, -2 + difficultyModifierEffects, true));
                            else if (((IguanaConfig.addLowHungerSlowness && foodLevel <= 5)
                                            || (IguanaConfig.addLowHealthSlowness && healthPercent <= 0.25F))
                                    && difficultyModifierEffects >= 3)
                                event.entityLiving.addPotionEffect(new PotionEffect(
                                        Potion.moveSlowdown.id, 19, -3 + difficultyModifierEffects, true));

                        if (IguanaConfig.addLowHealthMiningSlowdown || IguanaConfig.addLowHungerMiningSlowdown)
                            if ((IguanaConfig.addLowHungerMiningSlowdown && foodLevel <= 1)
                                    || (IguanaConfig.addLowHealthMiningSlowdown && healthPercent <= 0.05F))
                                event.entityLiving.addPotionEffect(new PotionEffect(
                                        Potion.digSlowdown.id, 19, 1 + difficultyModifierEffects, true));
                            else if ((IguanaConfig.addLowHungerMiningSlowdown && foodLevel <= 2)
                                    || (IguanaConfig.addLowHealthMiningSlowdown && healthPercent <= 0.10F))
                                event.entityLiving.addPotionEffect(
                                        new PotionEffect(Potion.digSlowdown.id, 19, difficultyModifierEffects, true));
                            else if (((IguanaConfig.addLowHungerMiningSlowdown && foodLevel <= 3)
                                            || (IguanaConfig.addLowHealthMiningSlowdown && healthPercent <= 0.15F))
                                    && difficultyModifierEffects >= 1)
                                event.entityLiving.addPotionEffect(new PotionEffect(
                                        Potion.digSlowdown.id, 19, -1 + difficultyModifierEffects, true));
                            else if (((IguanaConfig.addLowHungerMiningSlowdown && foodLevel <= 4)
                                            || (IguanaConfig.addLowHealthMiningSlowdown && healthPercent <= 0.20F))
                                    && difficultyModifierEffects >= 2)
                                event.entityLiving.addPotionEffect(new PotionEffect(
                                        Potion.digSlowdown.id, 19, -2 + difficultyModifierEffects, true));
                            else if (((IguanaConfig.addLowHungerMiningSlowdown && foodLevel <= 5)
                                            || (IguanaConfig.addLowHealthMiningSlowdown && healthPercent <= 0.25F))
                                    && difficultyModifierEffects >= 3)
                                event.entityLiving.addPotionEffect(new PotionEffect(
                                        Potion.digSlowdown.id, 19, -3 + difficultyModifierEffects, true));

                        if (IguanaConfig.addLowHealthWeakness || IguanaConfig.addLowHungerWeakness)
                            // Weakness effect
                            if (((IguanaConfig.addLowHungerWeakness && foodLevel <= 1)
                                            || (IguanaConfig.addLowHealthWeakness && healthPercent <= 0.05F))
                                    && difficultyModifierEffects >= 1)
                                event.entityLiving.addPotionEffect(
                                        new PotionEffect(Potion.weakness.id, 19, -1 + difficultyModifierEffects, true));
                            else if (((IguanaConfig.addLowHungerWeakness && foodLevel <= 2)
                                            || (IguanaConfig.addLowHealthWeakness && healthPercent <= 0.10F))
                                    && difficultyModifierEffects >= 2)
                                event.entityLiving.addPotionEffect(
                                        new PotionEffect(Potion.weakness.id, 19, -2 + difficultyModifierEffects, true));
                            else if (((IguanaConfig.addLowHungerWeakness && foodLevel <= 3)
                                            || (IguanaConfig.addLowHealthWeakness && healthPercent <= 0.15F))
                                    && difficultyModifierEffects >= 3)
                                event.entityLiving.addPotionEffect(
                                        new PotionEffect(Potion.weakness.id, 19, -3 + difficultyModifierEffects, true));
    ...
    public void onUseHoe(UseHoeEvent event) {
        if (IguanaConfig.modifyHoeUse) {
            ...
            if ((block == Blocks.dirt || block == Blocks.grass)
                    && isWaterNearby(event.world, event.x, event.y, event.z)) {
        ...
        if (IguanaConfig.addGuiText) {
            ...
            if (!player.isDead && !player.capabilities.isCreativeMode && !mc.gameSettings.showDebugInfo) {
                ...
                if (healthPercent <= 0.15F)
                    event.left.add(EnumChatFormatting.RED
                            + StatCollector.translateToLocal("hungeroverhaul.dying")
                            + EnumChatFormatting.RESET);
                else if (healthPercent <= 0.3F)
                    event.left.add(EnumChatFormatting.YELLOW
                            + StatCollector.translateToLocal("hungeroverhaul.injured")
                            + EnumChatFormatting.RESET);
                else if (healthPercent < 0.5F)
                    event.left.add(EnumChatFormatting.WHITE
                            + StatCollector.translateToLocal("hungeroverhaul.hurt")
                            + EnumChatFormatting.RESET);

                if (player.getFoodStats().getFoodLevel() <= 6)
                    event.right.add(EnumChatFormatting.RED
                            + StatCollector.translateToLocal("hungeroverhaul.starving")
                            + EnumChatFormatting.RESET);
                else if (player.getFoodStats().getFoodLevel() <= 10)
                    event.right.add(EnumChatFormatting.YELLOW
                            + StatCollector.translateToLocal("hungeroverhaul.hungry")
                            + EnumChatFormatting.RESET);
                else if (player.getFoodStats().getFoodLevel() <= 14)
                    event.right.add(EnumChatFormatting.WHITE
                            + StatCollector.translateToLocal("hungeroverhaul.peckish")
                            + EnumChatFormatting.RESET);
            }
        }
    }
    ...
    public void onEntityInteractEvent(EntityInteractEvent event) {
        if (IguanaConfig.milkedTimeout > 0
            ...
            if (equipped != null && equipped.getItem() != null) {
                ...
                if (item instanceof ItemBucket && ((ItemBucket) item).isFull == Blocks.air
                        || cow instanceof EntityMooshroom && item == Items.bowl) {
                    ...
                    if (tags.hasKey("Milked")) {
                        ...
                        if (!player.worldObj.isRemote)
                            cow.playSound(
                                    "mob.cow.hurt",
                                    0.4F,
                                    (event.entity.worldObj.rand.nextFloat() - event.entity.worldObj.rand.nextFloat())
                                                    * 0.2F
                                            + 1.0F);
    ...
    public void onPlayerInteraction(PlayerInteractEvent event) {
        ...
        if (IguanaConfig.foodsUnplantable
                && Loader.isModLoaded("harvestcraft")
                && event.entityPlayer.getHeldItem() != null
                && event.entityPlayer.getHeldItem().getItem() instanceof ItemPamSeedFood) {
            if (event.world.isRemote) {
                ...
                if (PamsModsHelper.canPlantSeedFoodAt(
                        event.entityPlayer,
            ...
            } else event.useItem = Result.DENY;
            return;
        }

        // right-click to harvest
        if (!IguanaConfig.enableRightClickHarvesting) return;
        ...
        if (rightClickHarvestBlacklist.contains(clicked)) return;

        if (Loader.isModLoaded("Natura") && clicked instanceof CropBlock) {
            if (meta == 3 || meta == 8) resultingMeta = meta == 3 ? 0 : 4;
        ...
        if (resultingMeta >= 0) {
            ...
            if (!event.world.isRemote
                    && !event.world
                            .restoringBlockSnapshots) // do not drop items while restoring blockstates, prevents item
            // dupe
            {
                ArrayList<ItemStack> drops = clicked.getDrops(event.world, event.x, event.y, event.z, meta, 0);
                float odds = ForgeEventFactory.fireBlockHarvesting(
                        drops,
                        event.world,
                        clicked,
                        event.x,
                ...
                List<ItemStack> modifiedDrops = BlockHelper.modifyCropDrops(
                        drops,
                        clicked,
                        meta,
                        IguanaConfig.seedsPerHarvestRightClickMin,
                        IguanaConfig.seedsPerHarvestRightClickMax,
                        IguanaConfig.producePerHarvestRightClickMin,
                        IguanaConfig.producePerHarvestRightClickMax);
            ...
            if (event.world.isRemote) {
                ClientHelper.sendRightClickPacket(
                        event.x,
                        event.y,
                        event.z,
                        event.face,
    ...
    public void onBlockHarvested(BlockEvent.HarvestDropsEvent event) {
        if (!IguanaConfig.modifyCropDropsBreak) return;

        // certain things we don't want to modify the drops of
        if (IguanaEventHook.harvestDropsBlacklist.contains(event.block)) return;
        ...
        boolean fullyGrown = (!isNaturaCrop && event.blockMetadata >= 7)
                || (isNaturaCrop && event.blockMetadata == 3 || event.blockMetadata == 8);
        ...
        List<ItemStack> modifiedDrops = BlockHelper.modifyCropDrops(
                ...
                event.block,
                event.blockMetadata,
                IguanaConfig.seedsPerHarvestBreakMin,
                IguanaConfig.seedsPerHarvestBreakMax,
                IguanaConfig.producePerHarvestBreakMin,
                IguanaConfig.producePerHarvestBreakMax);
        event.drops.clear();
        for (ItemStack drop : modifiedDrops) {
    ...
    public void renderTooltips(ItemTooltipEvent event) {
        if (IguanaConfig.addFoodTooltips && AppleCoreAPI.accessor.isFood(event.itemStack)) {
            ...
            if (hungerFill <= 1) noun = "morsel";
            else if (hungerFill <= 2) noun = "snack";
            else if (hungerFill <= 5) noun = "lightmeal";
            else if (hungerFill <= 8) noun = "meal";
            else if (hungerFill <= 11) noun = "largemeal";
            else noun = "feast";

            if (satiation >= 3.0F) adjective = "hearty";
            else if (satiation >= 2.0F) adjective = "wholesome";
            else if (satiation > 0.0F) adjective = "nourishing";
            else if (satiation < 0.0F) adjective = "unfulfilling";
            ...
            if (adjective != null && StatCollector.canTranslate("hungeroverhaul." + adjective + "." + noun)) {
                ...
                if (adjective != null) {
                    mealDescriptor = StatCollector.translateToLocalFormatted(
                            StatCollector.translateToLocal("hungeroverhaul." + adjective), mealDescriptor);
                }
            }
        ...
        if (IguanaConfig.wrongBiomeRegrowthMultiplier > 1) {
            ...
            if (event.itemStack.getItem() instanceof IPlantable) {
                growthModification = ModulePlantGrowth.getPlantGrowthModification(
                        ((IPlantable) event.itemStack.getItem()).getPlant(event.entityPlayer.worldObj, 0, 0, 0));
            } else if (event.itemStack.getItem() instanceof ItemBlock) {
                Block block = Block.getBlockFromItem(event.itemStack.getItem());
                if (block != null) growthModification = ModulePlantGrowth.getPlantGrowthModification(block);
            } else {
            ...
            if (growthModification != null && !growthModification.biomeGrowthModifiers.isEmpty()) {
                ...
                for (BiomeDictionary.Type biomeType : growthModification.biomeGrowthModifiers.keySet())
                    tooltip += biomeType.toString().substring(0, 1).toUpperCase()
                            + biomeType.toString().substring(1).toLowerCase() + ", ";
        ...
        for (int l = par2 - 4; l <= par2 + 4; ++l)
            for (int i1 = par3; i1 <= par3 + 1; ++i1)
                for (int j1 = par4 - 4; j1 <= par4 + 4; ++j1)
                    if (par1World.getBlock(l, i1, j1).getMaterial() == Material.water) return true;
